...
<form class="form-inline" role="form" style="float:left;">
  <div class="form-group has-feedback">
    <div class="input-group">
      ...
      <input id="queryText" class="form-control has-success" type="text" placeholder="关键词：会员id，会员名">
    </div>
  </div>
 ...
 <hr style="clear:both;">
    ...
    <script type="text/javascript">
        ...
        function pageQuery( pageno ) {
            ...
            if (isDesc){
                jsonData.orderText="total_amount desc";
            }else {
                jsonData.orderText="total_amount";
            }
            if ( searchFlag == true ) {
                ...
                success : function(result) {
                    ...
                    if ( result.code==100 ) {
                        ...
                        $.each(orders, function(i, order){
                            ...
                            if (order.vip!=null){
                                tableContent += '  <td>'+order.vip.id+'</td>';
